...
#+RESULTS[15de9f7f1bb56c565acddd28a7da35cccbfedc78]: math-functions
: VECTOR-REVERSE

#+NAME: test-math-functions-0
#+BEGIN_SRC lisp :results output raw

    (setq point3 '(10.0d0 20.0))
    (setq point4 '(20.0d0 20.0d0))
    (setq v (list point3 point4))
  (setq a-angle (* *pi* 0.5d0))
(let* ((vdir (normal-vector v))
      (voffset (vector-offset v 10.0))
      (point1 (nth 0  voffset))
      (point2 (nth 1 voffset))
      )
  ...
  (format t "|point3:| ~8,4F | ~8,4F |~%" (x-of point1) (y-of point1))
  (format t "|point4:| ~8,4F | ~8,4F |~%" (x-of point2) (y-of point2)))

(let ((v-rotate (vector-rotate v a-angle)))
        (format t "|direction-rotate:| ~8,4F | ~8,4F |~%" (x-of v-rotate) (y-of v-rotate))
        (format t "|direction-angle:| ~8,4F |  |~%" (rad-to-deg(angle-vector v-rotate)))
...
| point1:           |       10.0000 |         20.0000 |
| point2:           |       20.0000 |         20.0000 |
| direction-angle:  |        0.0000 |                 |
| point3:           |       20.0000 |         20.0000 |
| point4:           |       30.0000 |         20.0000 |
| direction-rotate: | (10.0d0 20.0) | (10.0d0 30.0d0) |
