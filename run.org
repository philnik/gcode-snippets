...
#+NAME: test-trochoidal-circle-array-610
#+BEGIN_SRC lisp :tangle yes :results output file :file trochoidal-circle-array-610-3.0mm-diameter-external.ngc :comments both :cache yes
  (setq output-stream *STANDARD-OUTPUT*)
                    ;;;linear step
  (setq l-step 2.0d0)
  (setq zi 0.0)
...
#+NAME: test-trochoidal-circle-array-610-data
#+BEGIN_SRC lisp :tangle yes :results output raw :comments both :cache yes
(setq output-stream *STANDARD-OUTPUT*)
                    ;;;linear step
(setq l-step 2.0d0)
(setq zi 0.0)
...
#+RESULTS[c1938b14366ef7e6abfca14540cfc371e0e8d30b]: test-trochoidal-circle-array-610-data
| l-step                    |     2.0 |       | mm      |
| zi                        |     0.0 |       | mm      |
| f-                        |   900.0 |       | mm/min  |
|---------------------------+---------+-------+---------|
...
| trochoidal-width          |     4.5 |       | mm      |
| internal-radius           |    50.0 |       | mm      |
| external-radius           |    54.5 |       | mm      |
|---------------------------+---------+-------+---------|
| internal-cutting-radius   | 48.4125 |       | mm      |
| external-cutting-radius   | 56.0875 |       | mm      |
| internal-cutting-daimeter |  96.825 |       | mm      |
| external-cutting-diameter | 112.175 |       | mm      |
|---------------------------+---------+-------+---------|
