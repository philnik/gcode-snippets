...
#+HEADER: :tangle yes :noweb yes :session step
#+HEADER: :results output file :file trochoidal-circle-array-610-3.0mm-diameter-external.ngc
#+HEADER: :comments both :cache yes 
#+BEGIN_SRC lisp  
  (setq output-stream *STANDARD-OUTPUT*)
                    ;;;linear step
  (setq l-step 2.0d0)
