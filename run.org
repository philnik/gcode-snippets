...
(setq internal-diameter 100.0)
(setq external-diameter 200.0)

(prologue 8000 output-stream)
(external-trochoidal-circle xystep zstep zsafe zstart zend fz fxy center tool-diameter internal-diameter external-diameter output-stream)
(epilogue output-stream) 
