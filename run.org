...
(setq external-diameter 116.0)

(prologue 8000 output-stream)
(trochoidal-circle xystep zstep zsafe zstart zend fz fxy center tool-diameter internal-diameter external-diameter output-stream)
(epilogue output-stream) 
